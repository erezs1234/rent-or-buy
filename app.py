...
with st.container():
    ...
    with col2:
        ...
        loans = st.number_input("💳 החזר הלוואות שוטפות", min_value=0, value=0, step=100)
...
if over_ratio:
    ...
    <div class="warning-box">
        ...
        ההחזר החודשי המרבי המותר (35%) הוא <b>{fmt(max_allowed_repayment)}</b>.<br>
    ...
    <div class="success-box">
        ...
        הכנסה פנויה: {fmt(disposable_income)} (הכנסות פחות הלוואות)<br>
        הבנק מאפשר החזר מקסימלי של <b>{fmt(max_allowed_repayment)}</b> (35%).<br>
