    ...
    with st.form("contact_form"):
        ...
        if submit_contact:
            if name and phone and email:
                ...
                # Perform Final Calculation for saving
                ...
                st.session_state.data.update({'name': name})
...
# --- STEP 3: Results Display ---
    ...
    max_allowed_repayment = int(disposable_income * 0.40) # Updated to 40%
    ...
    ratio = (d['rent'] / disposable_income * 100) if disposable_income > 0 else 0
